...
/// <summary>
/// Summary description for GroupMasterLogic
/// </summary>
///  
namespace AccosoftRML.Busiess_Logic.RawMaterial
{
    public class GroupMasterLogicRM
    {
        ...
        public string InsertSQL(GroupMasterEntityRM oEntity , bool bDocAutogenerated,   object mngrclassobj)
        {
        ...
        public string UpdateSQL(GroupMasterEntityRM oEntity, object mngrclassobj)
        {
            string sRetun = string.Empty;
            try
            {
    ...
    public class GroupMasterEntityRM
    {
        public GroupMasterEntityRM()
        {
            //
            // TODO: Add constructor logic here
            //
