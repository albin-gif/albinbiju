...
{
    public class MaterialReceiptSourceChangeRMLogic
    {
        ...
        #region " Fetch Data" 
        public DataSet FectchReceiptDetails(string sSlectedStation, string SupplierCode, string sSelectedRM,string Source, string UOM, string Project, string StartDate,string EndDate)
        {
            ...
            try
            {
               ...
               // if (!string.IsNullOrEmpty(Project))
                ...
                SQL = SQL + " order by RM_RECEPIT_DETAILS.RM_MPOM_ORDER_NO desc";
        ...
        public DataTable FillViewPurchaseOrder(string sFilterType, string StartDate, string SuppCode, string Source, string RmCode, string Project, string stnCode, string UomCode, string Branch, string sFromdate, string sTodate, object mngrclassobj)
        {
            ...
            try
            {
                ...
                {
                    SQL = " SELECT RM_PO_MASTER.RM_PO_PONO PCode,RM_PO_DETAILS.RM_RMM_RM_CODE RMCODE ,RM_RMM_RM_DESCRIPTION RMNAME,";
                    ...
                    SQL = SQL + " RM_PO_MASTER.AD_FIN_FINYRID Id,RM_PO_DETAILS.RM_SM_SOURCE_CODE SOCode,RM_SOURCE_MASTER.RM_SM_SOURCE_DESC SOName,";
                    SQL = SQL + " to_char(RM_PO_MASTER.RM_PO_PO_DATE,'DD-MON-YYYY') PDate,RM_PO_MASTER.RM_MPOM_PAYMENT_TERMS,";
                    SQL = SQL + " RM_PO_MASTER. RM_PO_VERIFIED VERIFIED, RM_PO_MASTER.RM_PO_APPROVED RM_PO_APPROVED, ";
                    SQL = SQL + " to_char(RM_PO_AGG_START_DATE,'dd/MM/YYYY') START_DATE,to_char(RM_PO_AGG_END_DATE,'dd/MM/YYYY') END_DATE , RM_PO_DETAILS.RM_POD_UNIT_PRICE PRICE , RM_PO_MASTER.RM_PO_AGG_END_DATE_REQUIRED_YN EndDateYN ";

                    SQL = SQL + " FROM RM_PO_MASTER,RM_PO_DETAILS,RM_SOURCE_MASTER, ";
                    ...
                    SQL = SQL + "  AND RM_PO_MASTER.ad_fin_finyrid = " + mngrclass.FinYearID + "  ";
                    SQL = SQL + "  AND RM_PO_MASTER.RM_PO_ENTRY_TYPE ='PURCHASE' ";
                    SQL = SQL + "  AND RM_PO_AGG_START_DATE> '" + System.Convert.ToDateTime(StartDate).ToString("dd-MMM-yyyy") + "'";
                    SQL = SQL + "  AND RM_PO_DETAILS.RM_SM_SOURCE_CODE = '" + Source + "' ";
                    ...
                    if (!string.IsNullOrEmpty(UomCode))
                        SQL = SQL + "  AND RM_PO_DETAILS.RM_UOM_UOM_CODE = '" + UomCode + "'";
        ...
        #region " sql insrt " 
        public string UpdateSQL(string FirstPONO,string NewPo, string NewPOStartDate, List<MaterialReceiptSourceChangeRMDet> EntityReceipt, object mngrclassobj)
        {
            ...
            try
            {
                ...
                foreach (var Data in EntityReceipt)
                {
                    ...
                    SQL = "update  RM_RECEPIT_DETAILS set RM_MPOM_ORDER_NO='" + NewPo + "', ";
                    ...
                    SQL = SQL + " RM_MRM_RECEIPT_DATE>='" + System.Convert.ToDateTime(NewPOStartDate).ToString("dd-MMM-yyyy") + "' ";
                    SQL = SQL + " and RM_RMM_RM_CODE ='" + Data.Item + "' and RM_SM_SOURCE_CODE='" + Data.source + "' ";

                    SQLArray.Add(SQL);
                }

                sRetun = oTrns.SetTrans(mngrclass.UserName, mngrclass.FinYearID, mngrclass.CompanyCode, DateTime.Now, "RTMRPO", "RTMRPO", false, Environment.MachineName, "U", SQLArray);
            }
            catch (Exception ex)
            {
    ...
    public class MaterialReceiptSourceChangeRMDet
    {
