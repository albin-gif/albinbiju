...
{
    public class MaterialReceiptPOChangeRMLogic
    {
        ...
        #region " sql insrt " 
        public string UpdateSQL(string FirstPONO,string NewPo, string NewPOStartDate, List<MaterialReceiptPOChangeRMDet> EntityReceipt, object mngrclassobj)
        {
    ...
    public class MaterialReceiptPOChangeRMDet
    {
